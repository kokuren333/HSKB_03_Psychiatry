---
title: "PANSとは何か"
description: "急性発症の強迫症状や摂食制限を伴う小児神経精神症候群としてのPANSを、診断概念、仮説的メカニズム、除外診断、臨床・研究上の注意点から整理する。"
aliases:
  - "PANSとは何か"
  - "小児急性発症神経精神症候群"
...
- PANDASは溶連菌感染との時間的関連を前提にする概念であり、PANSの一部として扱われることが多い。ただし、溶連菌、免疫、基底核回路の関与は全例で確立した機序ではない[1][2]。
...
![PANSの全体像](../asset/generated_infographics/PANSとは何か/PANSとは何か_01.png)
...
![PANSの仮説的メカニズム](../asset/generated_infographics/PANSとは何か/PANSとは何か_02.png)
...
![PANSの評価と支援](../asset/generated_infographics/PANSとは何か/PANSとは何か_03.png)
...
MOC更新候補: `sites/03_精神医学/00_MOC/`配下の精神医学、小児精神医学、神経免疫、疾患・症候群関連MOC。並列ジョブとの競合を避けるため、本記事からの大規模更新は行わない。
